...
const executeMigration = async (file, config) => {
  ...
  try {
    ...
    try {
      ...
      console.warn(
        '\nWarning, the migration run had no errors, but there was an error storing the migration result!',
        storeError
      );
    }
  } catch (error) {
    ...
    try {
      ...
      console.warn(
        '\nWarning, the migration run had errors and additionally there was an error storing the migration result!',
        storeError
      );
    }
