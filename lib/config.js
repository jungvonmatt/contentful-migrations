...
const STRATEGY_CONTENT = 'content';
/**
 * Get configuration
 * @param {Object} args
 */
const getConfig = async (args) => {
  const defaultOptions = {
    fieldId: 'migration',
    contentTypeId: 'contentful-migrations',
...
const getPromts = (data) => {
  return [
    ...
    },
    {
      ...
      when(answers) {
        return answers.strategy === STRATEGY_TAG;
      },
      default: function () {
        return data.fieldId;
      },
    },
    {
      ...
      when(answers) {
        return answers.strategy === STRATEGY_CONTENT;
      },
      default: function () {
...
module.exports.STRATEGY_TAG = STRATEGY_TAG;
module.exports.STRATEGY_CONTENT = STRATEGY_CONTENT;
